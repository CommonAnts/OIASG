...
def init():
	...
	game_header_switchpage_disabled_icons = [(resource.load_image(i) if i is not None else None) for i in
	                                         GAME_HEADER_SWITCHPAGE_DISABLED_ICONS]
	...
	game_pages_timetable_frame_plan_button_pressed_back = resource.load_image(
